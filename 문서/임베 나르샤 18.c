...
void reset()
{
  ...
  while(1)
  {
    ...
    if(reset_toggle == 1 && on_off_x == 0)
    {
      no_check_limit = 1;
      step_count_x = 0;
      X_move(1000, 800, DIR_RIGHT);
      reset_toggle = 2;
    }
    if(reset_toggle == 2 && on_off_x == 0)
    {
      no_check_limit = 0;
      Y_move(100000, 200, DIR_UP);
      reset_toggle = 3;
    }
...
void loop() // 리셋 시도본인데 이것도 더러움
{
  // if(toggle_1 == 0){
  //   if(on_off_y == 0){
  //     X_move(5000, 200, DIR_RIGHT);
  //     Y_move(2500, 400, DIR_UP);
  //     toggle_1 = 1;
  //   }
  // }
  // if(toggle_1 == 1){
  //   if(on_off_x == 0 && on_off_y == 0){
  //     X_move(5000, 200, DIR_LEFT);
  //     toggle_1 = 2;
  //   }
  // }
  // if(toggle_1 == 2){
  //   if(on_off_x == 0){
  //     Y_move(2500, 400, DIR_DOWN);
  //     toggle_1 = 0;
  //   }
  // }
