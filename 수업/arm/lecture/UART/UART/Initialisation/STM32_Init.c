...
#define __RCC_CFGR_VAL             0x001D8402  // <7=> PLLSRC * 9
...
#define __GPIOA_CRL               0x00000B04
#define __GPIOA_CRH               0x00000000
#define __GPIOB_CRL               0xFF300000
...
//    USART1->BRR  = __USART_BRR(__PCLK2, __USART1_BAUDRATE); // set baudrate
    if(__USART1_BAUDRATE == 4800 ) USART1->BRR  = 0x3A98; // set baudrate
    else if(__USART1_BAUDRATE == 9600 ) USART1->BRR  = 0x1D4C; // set baudrate
    else if(__USART1_BAUDRATE == 19200 ) USART1->BRR  = 0xEA6; // set baudrate
    else if(__USART1_BAUDRATE == 115200 ) USART1->BRR  = 0x271; // set baudrate
