 ...
 */
#define WAKEUP_BUTTON_PIN                GPIO_Pin_10
#define WAKEUP_BUTTON_GPIO_PORT          GPIOF
#define WAKEUP_BUTTON_GPIO_CLK           RCC_AHB1Periph_GPIOF
#define WAKEUP_BUTTON_EXTI_LINE          EXTI_Line10
#define WAKEUP_BUTTON_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOF
...
#define TAMPER_BUTTON_GPIO_PORT          GPIOF
#define TAMPER_BUTTON_GPIO_CLK           RCC_AHB1Periph_GPIOF
#define TAMPER_BUTTON_EXTI_LINE          EXTI_Line10
#define TAMPER_BUTTON_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOF
#define TAMPER_BUTTON_EXTI_PIN_SOURCE    EXTI_PinSource10
